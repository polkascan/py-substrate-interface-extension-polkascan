...
setup(
    ...
    name='substrate-interface-polkascan',  # Required
    ...
    description='py-substrate-interface extension to utilize Polkascan API indexes',  # Optional
    ...
    url='https://github.com/polkascan/py-substrate-interface-extension-polkascan',  # Optional
    ...
    keywords='substrate-interface extension polkascan api',  # Optional
